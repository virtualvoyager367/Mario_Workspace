package net.mcreator.mariocraft.network;
...
public class MarioCraftModVariables {
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			clone.CoinNumber = original.CoinNumber;
	...
	private static class PlayerVariablesProvider implements ICapabilitySerializable<Tag> {
		...
		public static void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
			if (event.getObject() instanceof Player && !(event.getObject() instanceof FakePlayer))
				event.addCapability(new ResourceLocation("mario_craft", "player_variables"), new PlayerVariablesProvider());
		}
	...
	public static class PlayerVariables {
		public double CoinNumber = 0;
		public boolean Grabbed_Coin = false;
		public double PurpleCoinNumber = 0;
		...
		public Tag writeNBT() {
			...
			nbt.putDouble("CoinNumber", CoinNumber);
			nbt.putBoolean("Grabbed_Coin", Grabbed_Coin);
			nbt.putDouble("PurpleCoinNumber", PurpleCoinNumber);
			return nbt;
		}
