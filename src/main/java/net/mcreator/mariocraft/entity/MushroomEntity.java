...
public class MushroomEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MushroomEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MushroomEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MushroomEntity.class, EntityDataSerializers.STRING);
	...
	public MushroomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MarioCraftModEntities.MUSHROOM.get(), world);
	}

	public MushroomEntity(EntityType<MushroomEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public static void init() {
		SpawnPlacements.register(MarioCraftModEntities.MUSHROOM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		++this.deathTime;
		if (this.deathTime == 1) {
			this.remove(MushroomEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
