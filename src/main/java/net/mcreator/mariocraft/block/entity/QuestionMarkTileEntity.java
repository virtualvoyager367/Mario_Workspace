package net.mcreator.mariocraft.block.entity;
...
public class QuestionMarkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public QuestionMarkTileEntity(BlockPos pos, BlockState state) {
		super(MarioCraftModBlockEntities.QUESTION_MARK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(QuestionMarkBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<QuestionMarkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<QuestionMarkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("question_mark");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Question Mark");
	}
